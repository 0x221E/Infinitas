% infinitas(SECTION) | User Commands
%
% "September 25 2025"
...
infinitas - program to do something

# SYNOPSIS

**infinitas** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**infinitas** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **infinitas** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**infinitas** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    infinitas. See **foo.conf**(5) for further details.
...
**infinitas** provides some return codes, that can be used in scripts:
...
Very Cool <cool@unknown>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright © 2007 Very Cool
